...
#define MATCH_SIMFENCE 0x6b
#define MASK_SIMFENCE  0x707f
#define MATCH_GETTIME 0x200b
#define MASK_GETTIME  0x707f
...
DECLARE_INSN(simfence, MATCH_SIMFENCE, MASK_SIMFENCE)
DECLARE_INSN(gettime, MATCH_GETTIME, MASK_GETTIME)
