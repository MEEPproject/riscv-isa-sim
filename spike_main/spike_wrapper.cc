...
{    
    ...
    */
    ...
    bool SpikeWrapper::simulateOne(uint16_t core, uint64_t current_cycle, std::list<std::shared_ptr<coyote::Event>>& events)
    {
    ...
    */
    bool SpikeWrapper::ackRegister(uint64_t coreId, coyote::Request::RegType destRegType, size_t destRegId, uint64_t timestamp)
    {
